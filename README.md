...
* [Prerequisites](#prerequisites)
  ...
  + [SSH into EC2 instance using PDS4 user](#ssh-into-ec2-instance-using-pds4-user)
     - [1. Python Virtual Environment](#1-python-virtual-environment)
     - [2. AWS Credentials (boto3)](#2-aws-credentials-boto3)
     - [3. Logstash](#3-logstash)
     - [4. envsubst (for environment variable substitution)](#4-envsubst-for-environment-variable-substitution)
* [Installation](#installation)
  + [1. Clone the Repository](#1-clone-the-repository)
  + [2. Set Up Python Environment](#2-set-up-python-environment)
  + [3. Configure Environment Variables](#3-configure-environment-variables)
  + [4. Set Up Logstash Configuration](#4-set-up-logstash-configuration)
     - [5. Set Up OpenSearch](#5-set-up-opensearch)
* [Package Structure](#package-structure)
  + [Installing the Package](#installing-the-package)
* [Configuration](#configuration)
  + [Logstash Configuration Structure](#logstash-configuration-structure)
  + [S3 Log Sync Configuration](#s3-log-sync-configuration)
* [Usage](#usage)
  + [1. S3 Log Synchronization](#1-s3-log-synchronization)
  + [2. Logstash Processing](#2-logstash-processing)
  + [3. Testing](#3-testing)
...
* [Development](#development)
  ...
  + [Adding New PDS Nodes](#adding-new-pds-nodes)
